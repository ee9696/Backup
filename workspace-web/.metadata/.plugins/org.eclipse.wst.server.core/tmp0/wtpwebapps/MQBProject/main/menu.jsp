...
<ul class="mainnav">
	...
	<c:if test="${memId != null }">
		...
		<li><a href="/MQBProject//guestbook/guestbookList.do">방명록 보기</a></li>
		
		<li><a href="/MQBProject/product/productWriteForm.do">상품 등록</a></li>
		<li><a href="/MQBProject/product/productList.do">상품 목록</a></li>
</ul>
